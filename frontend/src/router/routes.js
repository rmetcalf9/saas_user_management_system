...
export const projectName = 'saas_user_management' // Must match what is output from _repo_vars PROJECT_NAME
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'auth/apple', component: () => import('pages/AuthProvider_apple.vue'), beforeEnter: getGlobalBeforeEnterFn('AuthProvider_apple') },
